...
import { handleAuthorize, handleToken, requireAuthOrOAuth } from './oauth';
 ...
 * Initiates the authorization code flow. If CF Access is configured,
 * users will be redirected to CF Access login first.
 */
...
app.post('/mcp', rateLimit(30, 60000), requireAuthOrOAuth(), async (c) => {
...
app.post('/tools/:toolName', rateLimit(30, 60000), requireAuthOrOAuth(), async (c) => {
